...
Physics::AABB BrickWall::getAABBForBrickState(BrickWall::EBrickLocation location, BrickWall::EBrickState state, const glm::vec2& size)
{
...
{
    if (object.getObjectType() != EObjectType::Bullet) return;
